...
namespace Mudanzas.Models
{
    public class ModeloCamion
    {
        ...
        // POST CAMION
        public Camion RegistrarNuevoCamion(string id, decimal kilometraje, decimal kilometrajeUltimoServicio, decimal capacidadPeso, string tipoCamion, string tipoCombustible, decimal volumen, string placas)
        { 
